 ...
 * 
 * <p>
 * If you enable buffering by setting the <code>BufferedIO=true</code> property
 * in your log4j.properties file, there is no guarantee that DatedFileAppender
 * has finished writing to a daily log file after midnight. A new message must
 * be logged after midnight to force the previous day's log file to be flushed
 * and closed.
 * </p>
 * 
 * <p>
